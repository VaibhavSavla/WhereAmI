...
class PlaceAutoCompleteAdapter
    ...
    PlaceAutoCompleteAdapter(Context context, GoogleApiClient googleApiClient,
        ...
        super(context, R.layout.place_autocomplete_item);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.place_autocomplete_item, parent, false);
        }
        ...
        TextView textView1 = (TextView) convertView.findViewById(R.id.list_item_date_textview);
        TextView textView2 = (TextView) convertView.findViewById(R.id.list_item_forecast_textview);
        ImageView icon = (ImageView) convertView.findViewById(R.id.list_item_icon);
        textView1.setText(item.getPrimaryText(STYLE_BOLD));
        textView2.setText(item.getSecondaryText(STYLE_BOLD));
        icon.setImageResource(Utils.getDrawableFromPlaceId(item.getPlaceTypes()));
